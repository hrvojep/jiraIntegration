...
public class AbnSearchResult {
	...
	public String getOrganisationName() throws SecurityException, IllegalArgumentException, ClassNotFoundException,
		...
		return XMLUtils.getNodeText(searchResultsPayload,
				"/ABRPayloadSearchResults/response/businessEntity/mainName/organisationName");
	}

	public String getTradingName() throws SecurityException, IllegalArgumentException, ClassNotFoundException,
			NoSuchMethodException, IllegalAccessException, InvocationTargetException {
		return XMLUtils.getNodeText(searchResultsPayload,
				"/ABRPayloadSearchResults/response/businessEntity/mainTradingName/organisationName");
	}

	public String getExceptionDescription() throws SecurityException, IllegalArgumentException, ClassNotFoundException,
			NoSuchMethodException, IllegalAccessException, InvocationTargetException {
		return XMLUtils.getNodeText(searchResultsPayload,
				"/ABRPayloadSearchResults/response/exception/exceptionDescription");
	}
}
